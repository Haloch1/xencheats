...
const productCatalog = [
  {
    ...
    variants: [
      keyVariant("crusader-r6", "day", "1 Day Key", 539),
      keyVariant("crusader-r6", "week", "1 Week Key", 2159),
      keyVariant("crusader-r6", "month", "1 Month Key", 4319),
    ],
  },
  {
    ...r6Meta,
    ...
    variants: [
      keyVariant("vega-r6-external", "day", "1 Day Key", 539),
      keyVariant("vega-r6-external", "three-day", "3 Day Key", 1079),
      keyVariant("vega-r6-external", "week", "1 Week Key", 2699),
      keyVariant("vega-r6-external", "month", "1 Month Key", 5399),
    ],
  },
  {
    ...r6Meta,
    ...
    variants: [
      keyVariant("r6-frost", "day", "1 Day Key", 971),
      keyVariant("r6-frost", "week", "1 Week Key", 3023),
      keyVariant("r6-frost", "month", "1 Month Key", 5399),
    ],
  },
  {
    ...r6Meta,
  ...
  },
  {
    ...
    requirements: ["Windows 10", "Windows 11 21H2 - 25H2", "UEFI based motherboard"],
    variants: [
      keyVariant("r6-recoil-private", "day", "1 Day Key", 215),
      keyVariant("r6-recoil-private", "week", "7 Day Key", 647),
      keyVariant("r6-recoil-private", "month", "30 Day Key", 2159),
      keyVariant("r6-recoil-private", "lifetime", "Lifetime Key", 3239),
    ],
  },
  {
    ...r6Meta,
  ...
  },
  {
    ...
    variants: [
      keyVariant("invision-chams", "day", "1 Day Key", 323),
      keyVariant("invision-chams", "week", "7 Day Key", 1403),
      keyVariant("invision-chams", "month", "1 Month Key", 2699),
    ],
  },
  {
    ...r6Meta,
    ...
    requirements: ["Windows 10: 20H2 to 22H2", "Windows 11: 21H2 to 25H2"],
    variants: [
      keyVariant("r6-frost-lite", "day", "1 Day Key", 647),
      keyVariant("r6-frost-lite", "week", "1 Week Key", 2159),
      keyVariant("r6-frost-lite", "month", "1 Month Key", 4319),
    ],
  },
  {
    ...r6Meta,
    ...
    variants: [
      keyVariant("r6-unlock-all", "month", "1 Month Key", 3239),
      keyVariant("r6-unlock-all", "lifetime", "Lifetime Key", 7559),
    ],
  },
  {
    ...fortniteMeta,
