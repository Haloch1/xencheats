...
const productCatalog = [
  ...
  },
  {
    ...
    summary: "Ranked-ready prelinked NFA Rainbow Six Siege account delivered through the account fulfillment API.",
    features: ["Ranked-ready NFA account", "Prelinked account", "API fulfillment"],
    featureGroups: [
      { title: "Account", items: ["Non-Full Access (NFA)", "Ranked-ready", "Prelinked" ] },
      { title: "Delivery", items: ["API fulfillment after checkout", "Order status tracking", "Up to 5 accounts per order"] },
    ],
    generalInfo: [
      "This account listing uses API fulfillment after checkout.",
      "Account details are released through the order/account flow after the order is confirmed.",
    ],
  ...
  },
  {
    ...
    generalInfo: ["This product is delivered manually through Discord after payment. Contact support in Discord to receive your key and activation instructions."],
    requirements: ["Rainbow Six Siege account", "Windows PC", "Follow the supplied activation workflow"],
    variants: [
      keyVariant("unlock-all", "three-day", "3 Day Key", 699, { supplierVariantName: "3 Days", supplierDigital: false }),
      keyVariant("unlock-all", "week", "7 Day Key", 1499, { supplierVariantName: "Week", supplierDigital: false }),
      keyVariant("unlock-all", "month", "30 Day Key", 2999, { supplierVariantName: "Month", supplierDigital: false }),
    ],
  },
  {
    ...categoryMeta("DMA"),
