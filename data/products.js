...
const productCatalog = [
  ...
  },
  {
    ...
    checkoutBlocked: true,
    checkoutError: "Open a Discord ticket to confirm shipping before ordering this hardware.",
    ...
    generalInfo: ["This is a physical product. Shipping details must be confirmed with support before payment."],
    requirements: ["Available USB connection", "Compatible host and gaming computers", "Discord ticket for shipping confirmation"],
    variants: [keyVariant("makcu", "hardware", "MAKCU", 2499, { supplierVariantName: "MAKCU", supplierDigital: false, checkoutBlocked: true })],
  },
  {
    ...categoryMeta("DMA"),
    slug: "fuser",
    ...
    supplier: "sellauth",
    supplierProductName: "Fuser",
    checkoutBlocked: true,
    checkoutError: "Open a Discord ticket to confirm the connector and shipping details before ordering.",
    ...
    generalInfo: ["Choose the connector that matches the intended monitor and capture layout."],
    requirements: ["Compatible HDMI or DisplayPort setup", "Secondary display/capture layout", "Discord ticket for shipping confirmation"],
    variants: [
      keyVariant("fuser", "display-port", "DisplayPort", 9999, { supplierVariantName: "Display Port", supplierDigital: false, checkoutBlocked: true }),
      keyVariant("fuser", "hdmi", "HDMI", 9999, { supplierVariantName: "HDMI", supplierDigital: false, checkoutBlocked: true }),
    ],
  },
  {
    ...categoryMeta("DMA"),
  ...
  },
  {
    ...
    checkoutBlocked: true,
    checkoutError: "Open a Discord ticket to confirm hardware and shipping details before ordering.",
    ...
    generalInfo: ["This is physical hardware and does not include firmware unless explicitly stated."],
    requirements: ["Available PCIe slot", "Secondary PC or laptop", "USB 3.2 recommended", "Required cables and accessories", "Discord ticket for shipping confirmation"],
    variants: [
      keyVariant("dma-card", "75t-generic", "75T Generic DMA (No Firmware)", 9999, { supplierVariantName: "75T Generic DMA (NO FIRMWARE)", supplierDigital: false, checkoutBlocked: true }),
      keyVariant("dma-card", "100t-premium", "100T Premium DMA (No Firmware)", 10999, { supplierVariantName: "100T GHOSTWARE DMA PREMIUM (NO FIRMWARE)", supplierDigital: false, checkoutBlocked: true }),
    ],
  },
  {
    ...categoryMeta("DMA"),
    ...
    checkoutBlocked: true,
    checkoutError: "Open a Discord ticket to confirm the bundle configuration and shipping details before ordering.",
    ...
    generalInfo: ["Select both the DMA-card tier and fuser connector required for the intended setup."],
    requirements: ["Secondary PC or laptop", "Available PCIe slot", "Compatible monitor/capture layout", "Discord ticket for shipping confirmation"],
    variants: [
      keyVariant("dma-bundle", "75t-hdmi", "75T HDMI Bundle", 39999, { supplierVariantName: "75T HDMI Bundle", supplierDigital: false, checkoutBlocked: true }),
      keyVariant("dma-bundle", "75t-dp", "75T DisplayPort Bundle", 39999, { supplierVariantName: "75T DP Bundle", supplierDigital: false, checkoutBlocked: true }),
      keyVariant("dma-bundle", "100t-hdmi", "100T HDMI Bundle", 41999, { supplierVariantName: "100T HDMI Bundle", supplierDigital: false, checkoutBlocked: true }),
      keyVariant("dma-bundle", "100t-dp", "100T DisplayPort Bundle", 41999, { supplierVariantName: "100T DP Bundle", supplierDigital: false, checkoutBlocked: true }),
    ],
  },
];
